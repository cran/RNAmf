  ...
  if (fit$level == 2) { # level 2
    ...
    if (parallel) {
      pseudointvar <- foreach(i = 1:nrow(x.cand), .combine = cbind) %dopar% {
        ...
        return(c(
          obj.ALC_level_3_1(newx, Xref, fit_two_level, mc.sample),
          obj.ALC_level_3_2(newx, Xref, fit_two_level, mc.sample),
      ...
      for (i in 1:nrow(x.cand)) {
        ...
        intvar1[i] <- obj.ALC_level_3_1(newx, Xref, fit_two_level, mc.sample)
        intvar2[i] <- obj.ALC_level_3_2(newx, Xref, fit_two_level, mc.sample)
